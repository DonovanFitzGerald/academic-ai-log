const UseLogDisplay = ({ useLog }: { useLog }) => (
...
const UseCaseCard = ({ useCase }: { useCase }) => (
    <div className="rounded-lg border border-gray-100 bg-white p-4 shadow-sm">
        <h3 className="mb-2 text-lg font-semibold">{useCase.label}</h3>
        <div className="space-y-1 text-sm text-gray-700">
            <p>
                <span className="font-bold">Evidence:</span> {useCase.evidence}
            </p>
            <p>
                <span className="font-bold">Role:</span> {useCase.ai_role}
            </p>
            <p>
